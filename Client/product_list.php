 ...
 */
	...
	$arr["update_date"]=$_REQUEST['update_date'];
                                    ...
                                    <form class="form-horizontal" method="post">
                                        <fieldset>
                                            <div class="form-group">
                                                <label class="col-lg-2 control-label" for="date01">最后请求日期</label>
                                                <div class="col-lg-10">
                                                    <input type="text" class="form-control datepicker" name="update_date" value="2012-11-12">
                                                </div>
                                            </div>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
											...
											<tr>
												...
												<td><?php echo $rs[$i]["product_no"]; ?></td>
												<td><?php echo $rs[$i]["product_name"]; ?></td>
												<td><?php echo $rs[$i]["alias"]; ?></td>
												<td><?php echo $rs[$i]["category_name"]; ?></td>
												<td><?php echo $rs[$i]["class_name"]; ?></td>
												<td><?php echo $rs[$i]["class3_name"]; ?></td>
												<td><?php echo $rs[$i]["class4_name"]; ?></td>
												<td><?php echo $rs[$i]["standard_weight"]; ?></td>
											</tr>
												<?php
